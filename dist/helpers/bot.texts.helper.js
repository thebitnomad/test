const botTexts = {
    starting: "  ______ _      _______   ________  _____ _____ \r\n" +
              " |  ___| |    |  __ \\ \\ / /| ___ \\|  _  |_   _|\r\n" +
              " | |_  | |    | |__  \\ V / | |_/ /| | | | | |  \r\n" +
              " |  _| | |    |  __| /   \\ | ___ \\| | | | | |  \r\n" +
              " | |   | |____| |___/ /^\\ \\| |_/ /\\ \\_/ / | |  \r\n" +
  ...
  "Saudações *{$1}* 👋\n\n" +
  "Eu ajudo com:\n" +
  "• 🗞️ *{$p}noticias* — últimas do Livecoins.\n" +
  "• 📊 *{$p}analise <ativo>* — TL;DR em USD com variação 24h/7d, RSI(14), EMA20/50/200, Bandas de Bollinger, ATR(14), funding (Binance) e dominância BTC.\n\n" +
  "Para a lista completa de comandos, é só digitar " + `*{$p}menu*`,
    ...
    group_welcome_message: "Seja bem vindo(a) ao grupo *{$2}*\n\n" +
        "{$3}",
