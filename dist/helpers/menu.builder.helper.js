...
*|*
*|━━ ✦ 🔎 CONSULTAS/TEXTO* ✦
*|► ${prefix}analise* moeda - Análise rápida de criptomoedas
...
*|*
*|━━ ✦ ⌨️ ADMINISTRATIVO* ✦
*|► ${prefix}add* +55 119xxxxxxxx - Adiciona ao grupo
...
*|► ${prefix}frase* - Frases do Satoshi Nakamoto
...
*|*
*|━━ ✦ 🧩 ENTRETENIMENTO* ✦
*|► ${prefix}mascote* - Onipotente e onipresente Satoshi Nakamoto
*|► ${prefix}frase* - Frases dos onipotentes e onipresentes
